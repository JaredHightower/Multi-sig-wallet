...
contract('Wallet', (accounts) => {
    ...
    /* Test number of approvers & minimum quorum approvals needed */
    ...
    /* 
      * 1. Was the Struct Transfer created with correct values
      ! 2. Modifier should throw error of msg.sender is not approved
      
      Happy Path: Approver created transfer.
    */
    ...
    /*
      * 1. Was the Struct Transfer created with correct values
      ! 2. Modifier should throw error of msg.sender is not approved
       ...
       Unhappy Path: Non-Approver created transfer.
      */
